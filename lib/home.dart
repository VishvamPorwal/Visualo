import 'package:visualo/screens/augmented_faces.dart';
import 'package:visualo/screens/augmented_images.dart';
import 'package:visualo/screens/image_object.dart';
import 'package:visualo/screens/matri_3d.dart';
import 'package:visualo/screens/multiple_augmented_images.dart';
      ...
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => AugmentedFacesScreen(key: null,)));
            },
